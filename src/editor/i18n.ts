...
const rows: Record<string, readonly string[]> = {
  ...
  "최신 버전 반영하기": ["Apply latest version", "应用最新版本", "套用最新版本", "最新版を反映", "Aplicar última versión", "Appliquer la dernière version", "Neueste Version anwenden", "Aplicar versão mais recente", "Применить последнюю версию"],
  "기본 애니메이션 최신화": ["Update built-in animations", "更新内置动画", "更新內建動畫", "標準アニメーションを更新", "Actualizar animaciones integradas", "Mettre à jour les animations intégrées", "Integrierte Animationen aktualisieren", "Atualizar animações integradas", "Обновить встроенные анимации"],
  "기본 이름의 애니메이션을 현재 툴의 최신 프리셋으로 교체합니다.": ["Replaces animations with built-in names using the latest presets in this tool.", "用当前工具的最新预设替换使用内置名称的动画。", "以目前工具的最新預設取代使用內建名稱的動畫。", "標準名のアニメーションを現在のツールの最新プリセットに置き換えます。", "Sustituye las animaciones con nombres integrados por los ajustes más recientes de esta herramienta.", "Remplace les animations portant un nom intégré par les derniers préréglages de cet outil.", "Ersetzt Animationen mit integrierten Namen durch die neuesten Vorlagen dieses Tools.", "Substitui animações com nomes integrados pelas predefinições mais recentes desta ferramenta.", "Заменяет анимации со встроенными именами последними пресетами этого инструмента."],
  "직접 만든 동작과 이름을 바꾼 동작은 유지됩니다": ["Custom and renamed animations are kept", "保留自定义和已重命名的动画", "保留自訂和已重新命名的動畫", "自作および名前を変更したアニメーションは維持されます", "Se conservan las animaciones personalizadas y renombradas", "Les animations personnalisées et renommées sont conservées", "Benutzerdefinierte und umbenannte Animationen bleiben erhalten", "Animações personalizadas e renomeadas são mantidas", "Пользовательские и переименованные анимации сохраняются"],
  "최신화할 기본 애니메이션이 없습니다.": ["There are no built-in animations to update.", "没有可更新的内置动画。", "沒有可更新的內建動畫。", "更新できる標準アニメーションがありません。", "No hay animaciones integradas que actualizar.", "Aucune animation intégrée à mettre à jour.", "Keine integrierten Animationen zum Aktualisieren vorhanden.", "Não há animações integradas para atualizar.", "Нет встроенных анимаций для обновления."],
  "기본 애니메이션을 최신 프리셋으로 교체할까요? 직접 편집한 키는 초기화됩니다.": ["Replace built-in animations with the latest presets? Manually edited keys will be reset.", "是否用最新预设替换内置动画？手动编辑的关键帧将被重置。", "是否以最新預設取代內建動畫？手動編輯的關鍵影格將被重設。", "標準アニメーションを最新プリセットに置き換えますか？手動編集したキーはリセットされます。", "¿Sustituir las animaciones integradas por los ajustes más recientes? Las claves editadas se restablecerán.", "Remplacer les animations intégrées par les derniers préréglages ? Les clés modifiées seront réinitialisées.", "Integrierte Animationen durch die neuesten Vorlagen ersetzen? Manuell bearbeitete Keys werden zurückgesetzt.", "Substituir as animações integradas pelas predefinições mais recentes? As chaves editadas serão redefinidas.", "Заменить встроенные анимации последними пресетами? Изменённые вручную ключи будут сброшены."],
  "기본 애니메이션 {count}개를 최신 버전으로 반영했습니다.": ["Updated {count} built-in animations to the latest version.", "已将 {count} 个内置动画更新到最新版本。", "已將 {count} 個內建動畫更新至最新版本。", "標準アニメーション{count}個を最新版に更新しました。", "Se actualizaron {count} animaciones integradas a la última versión.", "{count} animations intégrées ont été mises à jour.", "{count} integrierte Animationen wurden auf die neueste Version aktualisiert.", "{count} animações integradas foram atualizadas para a versão mais recente.", "Встроенные анимации ({count}) обновлены до последней версии."],
  ...
  "PNG를 WebP로 용량 줄이기": ["Reduce PNG size with WebP", "将 PNG 转为 WebP 以减小体积", "將 PNG 轉為 WebP 以縮小容量", "PNGをWebPにして容量を削減", "Reducir PNG con WebP", "Réduire le PNG avec WebP", "PNG mit WebP verkleinern", "Reduzir PNG com WebP", "Уменьшить PNG с помощью WebP"],
  "PNG를 WebP로 변환": ["Convert PNG to WebP", "将 PNG 转换为 WebP", "將 PNG 轉換為 WebP", "PNGをWebPに変換", "Convertir PNG a WebP", "Convertir le PNG en WebP", "PNG in WebP umwandeln", "Converter PNG em WebP", "Преобразовать PNG в WebP"],
  "현재 PNG를 WebP로 압축하고 프로젝트에 적용합니다.": ["Compresses the current PNG as WebP and applies it to the project.", "将当前 PNG 压缩为 WebP 并应用到项目。", "將目前 PNG 壓縮為 WebP 並套用到專案。", "現在のPNGをWebPに圧縮してプロジェクトに適用します。", "Comprime el PNG actual como WebP y lo aplica al proyecto.", "Compresse le PNG actuel en WebP et l’applique au projet.", "Komprimiert das aktuelle PNG als WebP und übernimmt es ins Projekt.", "Comprime o PNG atual como WebP e aplica ao projeto.", "Сжимает текущий PNG в WebP и применяет его к проекту."],
  "투명 배경은 유지됩니다 · 변환 후 화질과 용량이 달라질 수 있습니다": ["Transparency is preserved · Quality and file size may change after conversion", "保留透明背景 · 转换后画质和文件大小可能会变化", "保留透明背景 · 轉換後畫質和檔案大小可能會變化", "透過背景は維持 · 変換後は画質と容量が変わる場合があります", "Se conserva la transparencia · La calidad y el tamaño pueden cambiar", "La transparence est préservée · La qualité et la taille peuvent changer", "Transparenz bleibt erhalten · Qualität und Dateigröße können sich ändern", "A transparência é preservada · A qualidade e o tamanho podem mudar", "Прозрачность сохраняется · Качество и размер файла могут измениться"],
  "WebP 변환 완료": ["WebP conversion complete", "WebP 转换完成", "WebP 轉換完成", "WebP変換完了", "Conversión a WebP completada", "Conversion WebP terminée", "WebP-Konvertierung abgeschlossen", "Conversão para WebP concluída", "Преобразование в WebP завершено"],
  "WebP로 변환하지 못했습니다.": ["Could not convert to WebP.", "无法转换为 WebP。", "無法轉換為 WebP。", "WebPに変換できませんでした。", "No se pudo convertir a WebP.", "Impossible de convertir en WebP.", "Konvertierung in WebP fehlgeschlagen.", "Não foi possível converter para WebP.", "Не удалось преобразовать в WebP."],
